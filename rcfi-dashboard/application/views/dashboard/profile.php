					...
					<div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <form action="<?php echo base_url() ?>controller/update_display_profile/" method="POST" id="myForm" enctype="multipart/form-data">
						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
                                <form action="<?php echo base_url() ?>controller/update_user_account/" method="POST" id="myForm" enctype="multipart/form-data">
                                    <div class="d-flex align-items-center">
                        ...
                        <div class="col-md-12">
							<div class="card">
								<div class="card-header">
                                <form action="<?php echo base_url() ?>controller/update_account_password/" method="POST" id="myForm" enctype="multipart/form-data">
                                    <div class="d-flex align-items-center">
